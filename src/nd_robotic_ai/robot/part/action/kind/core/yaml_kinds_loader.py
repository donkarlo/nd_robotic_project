...
from nd_robotic_ai.robot.part.action.kind.children import Child
from nd_robotic_ai.robot.part.action.kind.core.kind import Kind
    ...
    def _parse_action(self, title: str, children_raw: Any) -> Kind:
        ...
        if isinstance(children_raw, list):
            for child in children_raw:
                ...
                duration_raw = child.get("duration", child.get("time_based", None))
