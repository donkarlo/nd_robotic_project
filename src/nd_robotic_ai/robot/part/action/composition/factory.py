...
from nd_robotic_ai.robot.part.action.composition.composite import Composite as ActionComposite
from nd_utility.data.storage.kind.file.file import File
from nd_utility.os.file_system.path.path import Path

class Factory:

    @staticmethod
    def from_vecs_file_path(sample_action: ActionComposite, vecs_file_path:str, vec_sep: str = "\n", component_sep: str = " ")-> ActionComposite:
        """
        Clone multiple GoalGain instances from a file that contains lines of vector components.
        ...
        Returns:
            List of cloned GoalGain objects.
        """
