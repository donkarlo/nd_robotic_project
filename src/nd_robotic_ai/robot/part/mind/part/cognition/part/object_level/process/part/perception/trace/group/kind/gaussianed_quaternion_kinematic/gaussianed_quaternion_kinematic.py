...
from nd_robotic_ai.robot.robot import Storaged
...
from nd_robotic_ai.robot.robot import Kind as TraceGroupKind
from nd_robotic_ai.robot.robot import TimePosition
from nd_robotic_ai.robot.robot import GaussianedQuaternionKinematic as GaussianedQuaternionKinematicTraceKind
...
class  GaussianedQuaternionKinematic(TraceGroup, TraceGroupKind):
    ...
    def get_time_position_sequence_trace_group(self) -> np.ndarray:
        """
        TODO: This is a classification of action
        Returns:
        ...
        # TODO: must be removed and add a segrgated memory classification in all_modalities.schema.yaml
