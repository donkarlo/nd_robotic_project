...
from nd_robotic_ai.robot.robot import Composite as CompositeMemory
...
class FromNameDictionary:
    def __init__(self, raw_dic: Dic) -> None:
        ...
        if not isinstance(root_children, dict):
            raise TypeError("Root value must be a dict mapping classification names to subtrees.")
    ...
    def _build_subtree(
        ...
        """
        Recursively builds CompositeMemory classification from a nested dict.
        """
