...
from nd_robotic_ai.mind.cognition.process.kind.memory.composite.decorator.decorator import Decorator
from nd_robotic_ai.mind.cognition.process.kind.memory.composite.decorator.relationed.relations import Relations
