...
class Level2(Level):
    ...
    def test_video_temporal_contingency(self) -> UnitInterval:
        """
        Self-recognition under sequence_to_sequence offsets (live vs. delayed feed), testing whether
    ...
    def test_crossmodal_self_mapping(self) -> UnitInterval:
        ...
        RF/odometry trace_formation, odor tag), discriminating own signals from conspecifics.
        """
        return 0.0
