...
from nd_robotic.robot.structure.kind.mind.cognition.process.kind.memory.composite.trace.group.kind.core.kind import Kind  as TraceGoupKind
from nd_robotic.robot.structure.kind.mind.cognition.process.kind.memory.composite.trace.trace import Trace
from nd_robotic.robot.structure.kind.mind.cognition.process.kind.memory.composite.trace.group.interface import Interface as GroupInterface
...
class Group(MemoryComponent, BaseGroup, BaseLeaf, GroupInterface):
    ...
    def set_name(self, name:str)->None:
        """
        Maybe the name is voted among the mebers of the action_potential_group
        Args:
            name:
