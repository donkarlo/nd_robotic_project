...
class Language:
    ...
    - Language must be both useful for surviaval for example it must increase homeostasis value but it also should turn so much deceptive that it reverses back its direction to reduce and even exinct the robot or race.
