...
class Action(ActionComponent, BaseLeaf, ABC):
    ...
    This action can become so granular that to a command to change voltage in a rotor so in ROS we replaced Action for both Plan and COmmand and mission
    ...
    def __init__(self, goal: GoalComponent):
        ActionComponent.__init__(self, None)
