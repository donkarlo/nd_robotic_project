# from nd_robotic.structure.mind.process.composition.memory.composition.decorator.decorator import Decorator as CompositeMemoryDecorator
# from nd_robotic.structure.mind.process.composition.memory.composition.trace.action_potential_group.action_potential_group import Finite as StoragedTraceGroup
...
#     """
#     TODO: Must handle bothe the internal_storage in composition from which some trace groups might have derived and also all the trace groups which have internal_storage that they must and I must fix it
