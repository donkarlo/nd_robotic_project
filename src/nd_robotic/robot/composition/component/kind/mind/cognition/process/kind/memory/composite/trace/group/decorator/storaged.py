...
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.trace.group.decorator.decorator import Decorator as TraceGroupDecorator
