...
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.action.kind.intra.segregating.interface import Interface as SegregationInterface
