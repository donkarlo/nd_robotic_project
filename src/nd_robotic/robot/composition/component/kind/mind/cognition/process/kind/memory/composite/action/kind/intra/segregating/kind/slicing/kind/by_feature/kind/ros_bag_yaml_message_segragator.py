...
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.composite import Composite as MemoryComposite
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.action.kind.intra.segregating.segregating import Segregating
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.trace.group.decorator.storaged import Storaged
...
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.trace.kind.core.kind import Kind as TraceGroupKind
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.trace.group.kind.core.kind import Kind as TraceGroupKinds
...
class RosBagYamlMessageSegragating(FeatureSlicer, TraceAddValueSubscriber, GroupRamValuesAdditionFinishedSubscriber):
    ...
    def do_when_a_new_value_is_added_to_ram(self, value: Any) -> None:
        ...
        if isinstance(value, Dic):
            ...
            # note that trace composition title is the same as trace action_potential_group composition title in this case
            ...
            for trace_group_kind_name, trace_group in self._trace_groups_dic.get_keys_values():
                # we use starts with here because trace action_potential_group composition title is has a slice string in the end
