...
from nd_robotic.robot.composition.component.kind.mind.cognition.process.kind.memory.composite.trace.kind.core.kind import Kind as  SingleTraceKind
...
class Kind(ABC):
    ...
    def init_from_single_trace_kind(cls, single_trace_kind: SingleTraceKind):
        """
        Used when all members of the Finite are of the same trace composition
        Args:
            single_trace_kind:
    ...
    def set_name(self, name:str)->None:
        """
        Can be used buy others to vote for their title or currently I am using it to title it according to trace composition plus slc
        Args:
            name:
